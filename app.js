...
const loadPetsByCategory = (category, isSort = false) => {
  ...
  fetch(apiUrl)
    ...
    .then((data) => {
      loaderContainer.innerHTML = "";
      let categoryPet = data.data;
      if (isSort) categoryPet.sort((pet1, pet2) => pet2.price - pet1.price);
      showPetsByCategory(categoryPet);
    })
    .catch((error) => console.log(error));
};
